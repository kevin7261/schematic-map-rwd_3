/**
 * taipei_sn4_h → taipei_sn4_i：僅在 polyline 既有頂點上、依 g3→h3 插入的黑點（tags._forceDrawBlackDot）切段。
...
/**
 * @param {Array<object>} flatSegments - taipei_sn4_h spaceNetworkGridJsonData（flat）
