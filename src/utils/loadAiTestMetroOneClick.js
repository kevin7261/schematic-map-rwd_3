...
import { convertRmaFlatToAiTestRoutes } from '@/utils/rmaFlatToAiTestRoutes.js';
import { resetAiTestHvBridgeFiles } from '@/utils/uniformGridHvOptimizeExecute.js';
import OFFICIAL_MAP from '@/utils/metroOfficialMap.json';

export const AI_TEST_LAYER_ID = 'ai_test_layer';
export const AI_TEST_METRO_LOAD_FB = 'ai_test_layer:metro';
 ...
 */
export function useAiTestMetroOneClickCatalog(dataStore) {
