<!--
  🗺️ RouteMapAdjustTab.vue — 「路線圖調整」圖層專用 Upper 顯示分頁
...
<script>
  ...
  import { mountRouteMapAdjust } from '../utils/routeMapAdjust/renderRouteMapAdjust.js';

  export default {
    name: 'RouteMapAdjustTab',
    props: {
    ...
    setup(props) {
      ...
      const ensureMounted = () => {
        ...
        handle = mountRouteMapAdjust(el, dataStore);
      };
